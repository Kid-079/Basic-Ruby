...
if variable_total >= 70 && variable_total <= 100
	puts " A"
elsif variable_total >= 50 && variable_total <= 70
	puts " B"
elsif variable_total < 30 && variable_total >= 1
	puts " C"
...
END {puts " MOONS AND SUNS SHINING BRIGHT"}